    ...
    export default function HappyBirthday({ onNext }) {
        ...
        // Audio playback: autoplay attempt with gesture fallback, pause/resume on visibility change
        ...
        return (
            ...
            >
                ...
                >
                    ...
                    >
                        Anjali<span className="text-white">🧡</span>
                    </motion.h2>
                    ...
                    {/* Play / Pause audio control (small) */}
                    <div className="absolute top-4 right-4 z-30">
                        <button
                            ...
                            className="bg-white/80 text-gray-800 px-3 py-1 rounded-full shadow-sm hover:scale-105 transition-transform hidden"
                        >
